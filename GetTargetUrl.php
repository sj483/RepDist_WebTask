...
function GetTargetUrl($Dbc, $SId) {
    ...
    if ($State == 0) {
		...
		return "https://c01.learningandinference.org/Consent.html?SubjectId=$SId#";
		
	} else if ($State == 1) {
		// this should be called in consent actions 
		return "https://c01.learningandinference.org/Register.html?SubjectId=$SId#";
	
	} else if ($State == 2 or $State == 4) {
		// this should be called in RegActions
		return "https://c01.learningandinference.org/Instruct.html?SubjectId=$SId#";
		...
		return "https://c01.learningandinference.org/TItrain.html?SubjectId=$SId#";	
		...
		//return "https://c01.learningandinference.org/TIProbe.html?SubjectId=$SId#";		
		
	} else if ($State < 0) {
		// Kicked off
		return "https://c01.learningandinference.org/Coventry.html?SubjectId=$SId#";
		
		
	} else {
		// DECIDE THIS !
		// Finished all tasks (State=5) * add a call to landingactions.php in TIProbe 
		//return "https://c01.learningandinference.org/Complete.html?SubjectId=$SId#";
	}
}
